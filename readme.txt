...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	  добавляет объект в БД		  1. data - массив сданными по следующей 	  	нет			  JSON представление массива c сообщением об успехе	
 add	 				  структуре:					 				  и id последнего добавленного объекта			
	 				  data[purchase_id, number, url]. все свойства   				 							
	 				  обязательны и отсутствие приведет к ошибке	 				 							
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	  редактирует объект		  1. data - массив сданными по той же структуре, 	нет			  JSON представление массива c сообщением об успехе	
 edit	  	 			  что и при методе add но не все 		 				 							
	 				  свойства обязательны				 				 							
	 	  			  2. id - id редактируемого объекта		 				   							
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	  удаляет объект из БД		  1. id - id удаляемого объекта			 	нет			  JSON представление массива c сообщением об успехе	
 delete  				 						 				 							
